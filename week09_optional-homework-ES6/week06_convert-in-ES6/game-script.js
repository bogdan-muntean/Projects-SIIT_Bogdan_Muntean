typeof window !== 'undefined' ? console.log('You are on the browser') : console.log('You are on the server')
...
//Optional Homework 1. randomizam pozitia obstacolelor + 2. le adaugam pozitiile in obiecte, intr-un array
...
for (let i of Array(3).keys()) {
    ...
    do{
        ...
        }} while(obstacle.top < 50 && obstacle.left < 50)  
